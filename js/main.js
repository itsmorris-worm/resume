...
/*------------------------------project filter and popps-------------------------*/

(() => {
  const filterContainer = document.querySelector(".project-filter"),
    portfolioItemsContainer = document.querySelector(".project-items"),
...
(() => {
  const sliderContainer = document.querySelector(".blog-slider-container"),
    slides = sliderContainer.querySelectorAll(".blog-item"),
    slideWidth = sliderContainer.offsetWidth,
    prevBtn = document.querySelector(".blog-slider-nav .prev"),
    nextBtn = document.querySelector(".blog-slider-nav .next"),
    activeSlide = sliderContainer.querySelector(".blog-item.active");
  ...
  function slider() {
    ...
    sliderContainer
      .querySelector(".blog-item.active")
      .classList.remove("active");
    //activate new slide
